...
const projects = [
    ...
    {
        name: "Next estore",
        img: new URL(require("fd9464e8e583ec8c")),
...
new (0, _typeitDefault.default)(".typing", {
    ...
    delay: 100
}).type(`<span class="small-text"> I'm currently a senior computer science student.
...
/***********************  Mobile menu */ document.querySelector(".menu").addEventListener("click", handleClick);
...
skills.forEach((skill)=>{
    if (skill.type == "framework") icon = '<i class="fa-solid fa-cubes"></i>';
    else if (skill.type == "language") icon = `<i class="fa-solid fa-cube"></i>`;
    else if (skill.type == "database") icon = `<i class="fa-solid fa-database"></i>`;
...
},{"gsap":"fPSuC","typeit":"5plyB","b752cb54d7b7b9e8":"gbkXP","52c2dbc08d1a6357":"bPSlb","a65d84aa3e660715":"3YFCF","fd9464e8e583ec8c":"1eSHF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./helpers/bundle-url":"lgJ39"}],"1eSHF":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("6GAAC") + "nextstore.4b6f1328.jpg" + "?" + Date.now();
