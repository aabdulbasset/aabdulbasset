...
})({"aHYaq":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4de30c44ea2fdf7e";
...
},{}],"WPhGI":[function(require,module,exports) {
...
const projects = [
    {
        ...
        img: new URL(require("b752cb54d7b7b9e8")),
        url: "https://aabdulbasset.github.io/social-media-dashboard-with-theme-switcher-master/"
    },
    {
        name: "Pomodoro",
        img: new URL(require("52c2dbc08d1a6357")),
        url: "https://aabdulbasset.github.io/Prilliant/"
    },
    {
        name: "Landing page",
        img: new URL(require("a65d84aa3e660715")),
        url: "https://aabdulbasset.github.io/fylo-dark-theme/"
    }, 
];
//Cursor
const navElements = document.querySelectorAll(".nav-links a");
navElements.forEach((element1)=>{
    element1.addEventListener("mouseover", function handleMouseOver(e) {
        addCursor(e.target);
    });
    element1.addEventListener("mouseleave", function handleMouseLeave() {
        removeCursor();
    });
    // Selector
...
function addCursor(target) {
    element.id = "cursor";
    if (!target.classList.contains("selected")) target.appendChild(element);
}
function removeCursor() {
    document.querySelectorAll("#cursor").forEach((element2)=>{
        element2.remove();
    });
}
//Selector Function
...
let left = 0;
// Logo animation
let logoAnimation = (0, _gsap.gsap).to(logo, {
    duration: 1,
    y: -10,
    yoyo: true,
    repeat: -1,
...
function animationCompleted() {
    if (logoAnimation.progress() < 0.1 && left === 1) logoAnimation.pause();
}
function handleMouseLeave() {
    left = 1;
}
//********************** TYPING EFFECT
new (0, _typeitDefault.default)(".typing", {
    speed: 50,
    startDelay: 1000
}).type(`<strong class="large-text">Hello there 👋,</br> My name is <a href='https://www.linkedin.com/in/aabdulbasset/'>Ahmed Abdulbasset.</a> 
</br></strong><span class='medium-text'>I'm a full-stack web developer.</span></br></br>`, {
    delay: 100
}).type(`<span class="small-text"> I'm currently a senior computer science student at Sixth of October University, Giza, Egypt.
</br>I have always loved problem-solving, so I picked up programming; specifically, Web Programming 🤗. 
I'm currently learning React, Docker and mastering Javascript.</span></br></br> <span class='footer-text'>So, What do you think 💭?</span>`).go();
new (0, _typeitDefault.default)(".typing-projects", {
    speed: 50,
    waitUntilVisible: true,
    cursor: false
}).type(`Projects`).go();
/***********************  Mobile menu */ let button = document.querySelector(".menu").addEventListener("click", handleClick);
function checkOpened() {
    if (document.querySelector(".dropdown").classList.contains("opened")) return true;
    else return false;
}
function closeMenu() {
    document.querySelector(".dropdown").classList.remove("opened");
    document.querySelector(".menu").classList.remove("opened");
    (0, _gsap.gsap).timeline().add("up").to(".dropdown", {
        height: 0,
        duration: 0.5
    }, "up").to(".dropdown-container a", {
        fontSize: 0,
        duration: 0.5
    }, "up").add("hide")//.to(".projects-container", { display: "flex", duration: 0 }, "hide")
    .to(".dropdown", {
        display: "none",
        duration: 0.1
    }, "hide").to(".ti-cursor", {
...
function openMenu() {
    ...
    (0, _gsap.gsap).timeline().add("display").to(".dropdown", {
        display: "block",
        duration: 0.1
    }, "display")//.to(".projects-container", { display: "none", duration: 0 })
    .add("dropdown").to(".dropdown", {
        height: "100%",
        duration: 0.5
    }, "dropdown").to(".dropdown-container a", {
        fontSize: "3em",
        duration: 0.5
    }, "dropdown").to(".ti-cursor", {
        display: "none",
        duration: 0.1
    }, "dropdown");
}
...
function handleIntersection(entries, observer) {
    ...
    if (entries[0].target.id == "projects" && entries[0].isIntersecting) {
        ...
        openProjects();
    } else if (entries[0].target.id == "projects" && entries[0].isIntersecting == false) closeProjects();
...
function openProjects() {
    (0, _gsap.gsap).timeline().add("width").to(".projects-container", {
        width: width,
        height: height,
        duration: 0.3
    }, "width").add("add").to(".header-container, .project-card", {
        display: "flex",
        duration: 0
    }, "add").add("display").to(".header-container, .project-card", {
        opacity: 1,
        duration: 0.3
    }, "add");
}
function closeProjects() {
    (0, _gsap.gsap).timeline().add("hide").to(".header-container, .project-card", {
        opacity: 0,
        duration: 0.3
    }, "hide").add("height").to(".projects-container", {
        height: 0,
        width: 0,
        duration: 0.3
    }, "height").add("remove").to(".header-container,.project-card", {
        display: "none",
        duration: 0
    }, "remove");
}

},{"gsap":"fPSuC","typeit":"5plyB","b752cb54d7b7b9e8":"gbkXP","52c2dbc08d1a6357":"bPSlb","a65d84aa3e660715":"3YFCF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5plyB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
let Queue = function(initialItems) {
    let add = function(steps) {
        asArray(steps).forEach((step)=>{
            var _a;
            return _q.set(Symbol((_a = step.char) == null ? void 0 : _a.innerText), {
                ...step
            });
        });
        return this;
...
var repositionCursor = (element, allChars, newCursorPosition)=>{
    ...
    if (nodeToInsertBefore) return nodeToInsertBefore.before(cursor);
...
const TypeIt = function(element, options = {}) {
    ...
    let _prepLoop = async (delay)=>{
        ...
        for (let _i of _getAllChars())await _wait(_delete, _getPace(1));
        _queue.reset();
        _queue.set(0, {
            delay
        });
    ...
    let _delete = ()=>{
        ...
        else removeNode(allChars[_cursorPosition]);
    };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gbkXP":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("6GAAC") + "social-dashboard.4a5d5df9.jpg" + "?" + Date.now();
...
},{}],"bPSlb":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("6GAAC") + "pomodoro.231da06b.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"3YFCF":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("6GAAC") + "landing.2f8830c9.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["aHYaq","WPhGI"], "WPhGI", "parcelRequire2041")

//# sourceMappingURL=index.ea2fdf7e.js.map
